...
open class Popover: UIView {
  ...
  open var popupCornerRadious: CGFloat = 6.0
  ...
  open func show(_ contentView: UIView, point: CGPoint, inView: UIView) {
    ...
    self.contentView.layer.cornerRadius = self.popupCornerRadious
  ...
  override open func draw(_ rect: CGRect) {
    ...
    case .up:
      ...
      arrow.addLine(to: CGPoint(x: self.popupCornerRadious, y: self.bounds.height - self.arrowSize.height))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.popupCornerRadious,
          y: self.bounds.height - self.arrowSize.height - self.popupCornerRadious
        ),
        radius: self.popupCornerRadious,
        startAngle: self.radians(90),
        endAngle: self.radians(180),
        clockwise: true)

      arrow.addLine(to: CGPoint(x: 0, y: self.popupCornerRadious))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.popupCornerRadious,
          y: self.popupCornerRadious
        ),
        radius: self.popupCornerRadious,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width - self.popupCornerRadious, y: 0))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.popupCornerRadious,
          y: self.popupCornerRadious
        ),
        radius: self.popupCornerRadious,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.arrowSize.height - self.popupCornerRadious))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.popupCornerRadious,
          y: self.bounds.height - self.arrowSize.height - self.popupCornerRadious
    ...
    case .down, .auto:
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width - self.popupCornerRadious, y: self.arrowSize.height))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.popupCornerRadious,
          y: self.arrowSize.height + self.popupCornerRadious
        ),
        radius: self.popupCornerRadious,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.popupCornerRadious))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.popupCornerRadious,
          y: self.bounds.height - self.popupCornerRadious
        ),
        radius: self.popupCornerRadious,
        startAngle: self.radians(0),
        endAngle: self.radians(90),
      ...
      arrow.addLine(to: CGPoint(x: 0, y: self.arrowSize.height + self.popupCornerRadious))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.popupCornerRadious,
          y: self.arrowSize.height + self.popupCornerRadious
    ...
    case .left:
        ...
        arrow.addLine(to: CGPoint(x:self.bounds.width - self.arrowSize.height, y: self.bounds.height - self.popupCornerRadious))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width - self.arrowSize.height - self.popupCornerRadious,
                y: self.bounds.height - self.popupCornerRadious
            ),
            radius: self.popupCornerRadious,
        ...
        arrow.addLine(to: CGPoint(x: self.popupCornerRadious, y: self.bounds.height))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.popupCornerRadious,
                y: self.bounds.height - self.popupCornerRadious
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width - self.arrowSize.height - self.popupCornerRadious, y: 0))
        arrow.addArc(
            withCenter: CGPoint(x: self.bounds.width - self.arrowSize.height - self.popupCornerRadious,
                                y: self.popupCornerRadious
            ),
            radius: self.popupCornerRadious,
            startAngle: self.radians(270),
    ...
    case .right:
        ...
        arrow.addArc(
            withCenter: CGPoint(
                x: arrowPoint.x + self.arrowSize.height + self.popupCornerRadious,
                y: self.bounds.height - self.popupCornerRadious
            ),
            radius: self.popupCornerRadious,
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width + arrowPoint.x - self.popupCornerRadious, y: self.bounds.height))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width + arrowPoint.x - self.popupCornerRadious,
                y: self.bounds.height - self.popupCornerRadious
            ),
            radius: self.popupCornerRadious,
            startAngle: self.radians(90),
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width + arrowPoint.x, y: self.popupCornerRadious))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width + arrowPoint.x - self.popupCornerRadious,
                y: self.popupCornerRadious
        ...
        arrow.addLine(to: CGPoint(x: arrowPoint.x + self.arrowSize.height - self.popupCornerRadious, y: 0))
        arrow.addArc(
            withCenter: CGPoint(x: arrowPoint.x + self.arrowSize.height + self.popupCornerRadious,
                                y: self.popupCornerRadious
            ),
            radius: self.popupCornerRadious,
            startAngle: self.radians(-90),
