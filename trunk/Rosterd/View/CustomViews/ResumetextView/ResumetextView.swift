...
protocol ResumetextViewDelegate: class {
...
class ResumetextView: UIView {
    ...
    let nibName = "ResumetextView"
    weak var ResumetextViewDelegate: ResumetextViewDelegate?
...
extension ResumetextView : UITextFieldDelegate {
